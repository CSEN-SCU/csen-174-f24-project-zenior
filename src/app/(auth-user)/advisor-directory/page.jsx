...
const rows = [
  createData("Michael", "Abbott", "Mechanical Engineering", [
    "hydroinformatics",
  ]),
  createData("Margareta", "Ackerman", "Computer Science and Engineering", [
    "human-centered generative AI",
    "computational creativity",
    "machine learning",
  ]),
  createData("Ahmed", "Amer", "Computer Science and Engineering", [
    "data storage",
    "data processing",
    "data management",
  ]),
  ...
  createData("Ismail", "Araci", "Bioengineering", [
    "optics",
    "microfluidics",
    "biochemistry",
    "physical rehabilitation",
  ]),
  createData("Prashanth", "Asuri", "Bioengineering", [
    "in vitro platforms",
    "in vivo phenomena",
    "tissue engineering",
    "healthcare innovation",
  ]),
  createData("Darren", "Atkinson", "Computer Science and Engineering", [
    "digital libraries",
    "refactoring",
    "visualization",
  ]),
