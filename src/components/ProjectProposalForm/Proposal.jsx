        ...
        <div className="w-full">
          ...
          <div className="flex items-center mb-4 space-x-4">
            <div>
              ...
              <aside className="w-48 text-xs">
                Add the names of people who have already agreed to be members of
                this project. You may leave this section blank for now.
              </aside>
            </div>
          ...
          <div className="flex items-center mb-4 space-x-4">
            <div>
              ...
              <aside className="w-48 text-xs">
                Add the names of a faculty member who has already agreed to be
                an advisor for this project. You may leave this section blank
                for now.
              </aside>
            </div>
            <input
